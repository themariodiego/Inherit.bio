...
export const REGIONAL_TOGGLE_LABEL = "Keep small estimates hidden";
export const REGIONAL_HIDDEN_LABEL = "Hidden small estimates:";
export const REGIONAL_FILTER_NOTE = "When on, the filter hides shares below two percent. This display rule does not test whether a share is real. Shading uses the estimated share because there is no tested range yet.";
