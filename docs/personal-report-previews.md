...
The report library now shows a short personal takeaway on three existing
...
not just these three. Missing, no-call, unrecognized and conflicting calls
...
## Exactly three reviewed associations
...
Unit tests cover all nine mapped calls, wrong loci/alleles, absent and invalid
...
read three takeaways without a new gate, filter/search real interpreted results,
...
Verified locally on 2026-09-05: 1,532 unit tests, 28 final targeted tests,
