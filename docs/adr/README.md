...
| [0032](./0032-jurisdiction-declaration.md) | The jurisdiction declaration: one writer, a first-sign-in gate, and re-evaluation without a revision bump | Implementation decision for review |
